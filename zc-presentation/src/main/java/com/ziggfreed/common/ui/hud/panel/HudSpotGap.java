 ...
 * be nothing above it.
 *
 * <p>One group, shared by {@link HudSpotAsset} (where a spot leaves its band) and
 ...
 */
public final class HudSpotGap {

    @Nullable protected Integer afterRow;
    @Nullable protected Integer pixels;

    public static final BuilderCodec<HudSpotGap> CODEC = BuilderCodec
            .builder(HudSpotGap.class, HudSpotGap::new)
    ...
    public HudSpotGap(@Nullable Integer afterRow, @Nullable Integer pixels) {
     ...
     */
    @Nonnull
    public HudSpotGap over(@Nullable HudSpotGap under) {
        return new HudSpotGap(
    ...
    public String toString() {
        return "HudSpotGap{afterRow=" + afterRow + ", pixels=" + pixels + "}";
    }
}
