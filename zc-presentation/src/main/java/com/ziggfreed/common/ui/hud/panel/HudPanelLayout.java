 ...
 * measured. The drawing itself is identical for every panel, so it lives once in {@link HudPanelHud}
 ...
 *
 * @param panelId           the {@link HudPanelAsset} id this panel reads its authored leaves from
 ...
 */
public record HudPanelLayout(@Nonnull String panelId, @Nonnull String hudKey, @Nonnull String template,
