 ...
 *
 * <p>Deliberately not a reward and deliberately not a {@code RewardSpec}. A chip is what a player
 * looks at before deciding whether a quest is worth taking, so it carries only what a row can paint;
 * what will actually be paid out stays the spec's business right up to the moment it is granted.
 *
