 ...
 * hundreds and a wall of "locked, 0/1" tells the reader nothing about this player. An id whose
 * definition has gone is shown as an orphan rather than skipped, on the same reasoning as the quest
 * twin: a record nothing can progress is what somebody came here to find.
 */
