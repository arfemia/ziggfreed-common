...
public final class DialogueActionExecutor {
    ...
    /** Public: {@link DialogueEngine} constructs one from the package root when it assembles an engine. */
    public DialogueActionExecutor(@Nonnull Map<Class<? extends DialogueAction>, DialogueActionHandler<?>> handlers,
     ...
     *
     * <p>Public for {@link DialogueEngine}, the one caller that adopts a contributed type's handler.
     */
    public boolean adoptHandler(@Nonnull Class<? extends DialogueAction> actionClass,
