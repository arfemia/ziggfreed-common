...
public final class NpcPlacementAsset
    ...
    public static final class Requires {
        ...
        /**
         * The authored conditions without copying, for the hot evaluation path. Public:
         * {@code npc.placement.registry.PlacementFactorRegistry} reads it from across the
         * asset/registry package boundary.
         */
        @Nonnull
