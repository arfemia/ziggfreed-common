...
[`HealthUtil.scaleMaxHealth(Holder, factor, key)`](../../../../../../../../zc-core/src/main/java/com/ziggfreed/common/health/HealthUtil.java) overload (raise a
mob's HP MAX inside a pre-add spawn hook) and the [`EntityIdentifierUtil`](../../../../../../../../zc-core/src/main/java/com/ziggfreed/common/util/EntityIdentifierUtil.java)
